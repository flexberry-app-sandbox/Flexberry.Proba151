...
namespace IIS.Proba15
{
    ...
    [View("РегистАнкетыE", new string[] {
            "ДатаРегистр as \'Дата регистрации\'",
            "ФИОКандидата as \'ФИО кандидата\'",
            "СерНомПаспорта as \'Серия и номер паспорта\'",
            "ИНН as \'ИНН\'",
            "Снилс as \'Снилс\'",
            "НомерТелефона as \'Номер телефона\'",
            "ЭлПочта as \'Электронная почта\'",
            "ВакантДолжн as \'Вакантная должность\'",
            "ВакантДолжн.Должности as \'Вакантная должность\'",
            "Организация as \'Наименование организации\'",
            "Организация.Наименование as \'Наименование\'"}, Hidden=new string[] {
            "ВакантДолжн.Должности",
            "Организация.Наименование"})]
    [MasterViewDefineAttribute("РегистАнкетыE", "ВакантДолжн", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Должности")]
    ...
    public class РегистАнкеты : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba15.ВакантДолжн fВакантДолжн;
        ...
        /// ФИОКандидата.
        /// </summary>
        // *** Start programmer edit section *** (РегистАнкеты.ФИОКандидата CustomAttributes)

        // *** End programmer edit section *** (РегистАнкеты.ФИОКандидата CustomAttributes)
        [StrLen(255)]
        public virtual string ФИОКандидата
        {
            get
            {
                // *** Start programmer edit section *** (РегистАнкеты.ФИОКандидата Get start)

                // *** End programmer edit section *** (РегистАнкеты.ФИОКандидата Get start)
                string result = this.fФИОКандидата;
                // *** Start programmer edit section *** (РегистАнкеты.ФИОКандидата Get end)

                // *** End programmer edit section *** (РегистАнкеты.ФИОКандидата Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (РегистАнкеты.ФИОКандидата Set start)

                // *** End programmer edit section *** (РегистАнкеты.ФИОКандидата Set start)
                this.fФИОКандидата = value;
                // *** Start programmer edit section *** (РегистАнкеты.ФИОКандидата Set end)

                // *** End programmer edit section *** (РегистАнкеты.ФИОКандидата Set end)
            }
        }
        ...
        [PropertyStorage(new string[] {
                "ВакантДолжн"})]
        [NotNull()]
        public virtual IIS.Proba15.ВакантДолжн ВакантДолжн
        {
            get
            {
                ...
                IIS.Proba15.ВакантДолжн result = this.fВакантДолжн;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыE", typeof(IIS.Proba15.РегистАнкеты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыL", typeof(IIS.Proba15.РегистАнкеты));
                }
            }
        }
    }
